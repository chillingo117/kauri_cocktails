    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400">Crafted with care, served with style</p>
        </div>
        ...
        <div className="grid gap-6 mb-8">
          {menuItems.map((item) => (
            <button
              ...
              className="bg-slate-800 hover:bg-slate-700 transition-all duration-300 rounded-lg p-6 text-left border border-slate-700 hover:border-amber-500 group"
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <h3 className="text-2xl font-semibold text-white mb-2 group-hover:text-amber-500 transition-colors">
                    {item.name}
                  </h3>
